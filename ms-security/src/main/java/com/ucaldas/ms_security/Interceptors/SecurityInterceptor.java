package com.ucaldas.ms_security.Interceptors;
...
public class SecurityInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
                             ...
                             Object handler)
            throws Exception {
        //El validatorSerive es el que valida como esta la peticion
        //En la request viene toda la peticion que se manda desde postman
